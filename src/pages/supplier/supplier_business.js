...
import PendingSupplierBusiness from "./pendingBusiness";
import SuspendedSupplierBusiness from "./suspendedBusiness";
    ...
    >
      <Tabs.List>
        <Tabs.Tab value="first">
          <span style={{ color: "#666666", fontWeight: "bold" }}>Active</span>
        </Tabs.Tab>
      ...
      <Tabs.Panel value="second">
        <PendingSupplierBusiness activeTab={activeTab}/>
      </Tabs.Panel>
      <Tabs.Panel value="third">
        <SuspendedSupplierBusiness activeTab={activeTab}/>
      </Tabs.Panel>
