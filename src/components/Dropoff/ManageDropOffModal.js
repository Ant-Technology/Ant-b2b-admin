          ...
          {dropOffData && dropOffData.dropoff.driver !== null ? (
            <>
              ...
              <Group position="apart" mt="md" mb="xs">
                <Text weight={500}>
                  Name: {dropOffData?.dropoff.driver?.name}
                </Text>
                <Badge color="green" variant="light">
                  City: {dropOffData?.dropoff.driver?.city}
                </Badge>
              </Group>
              <Text size="sm" color="dimmed">
                Phone: {dropOffData?.dropoff.driver?.phone}
                <br />
          ...
          ? dropOffData?.dropoff.dropoff_order.map((data, idx) => (
              <Card key={idx} shadow="sm" p="lg" my="md" radius="md" withBorder>
                <Group position="apart" mt="md" mb="xs">
                  ...
                  <Badge
                    color={data.received ? "green" : "red"}
                    variant="light"
                  >
                    {dropOffData && data.received ? "Recieved" : "Not Recieved"}
                  </Badge>
